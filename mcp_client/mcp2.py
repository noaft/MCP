...
mcp = FastMCP("ecommerce_tools_2")

@mcp.tool()
async def get_customer_info_2(customer_id: str) -> str:
...
@mcp.tool()
async def get_order_details_2(order_id: str) -> str:
...
@mcp.tool()
async def check_inventory_2(product_name: str) -> str:
...
@mcp.tool()
async def get_customer_ids_by_name_2(customer_name: str) -> list[str]:
...
@mcp.tool()
async def get_orders_by_customer_id_2(
    customer_id: str,
